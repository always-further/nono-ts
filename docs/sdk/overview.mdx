...
|----------------|-------------|
| [`Examples`](/sdk/examples) | Runnable JavaScript and TypeScript scenarios |
| [`CapabilitySet`](/sdk/capability-set) | Build a set of filesystem and network capabilities |
| [`QueryContext`](/sdk/query-context) | Query whether operations would be permitted |
| [`SandboxState`](/sdk/sandbox-state) | Serialize and deserialize sandbox state |
| [`apply()`](/sdk/functions#apply) | Apply the sandbox with given capabilities |
| [`isSupported()`](/sdk/functions#issupported) | Check if sandboxing is available |
| [`supportInfo()`](/sdk/functions#supportinfo) | Get detailed platform support information |
